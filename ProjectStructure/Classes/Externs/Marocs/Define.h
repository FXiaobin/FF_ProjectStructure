...
///打印日志
#ifdef DEBUG
#define DDLog(...) NSLog(@"%s-[第%d行]-打印结果: %@\n\n",__func__,__LINE__,[NSString stringWithFormat:__VA_ARGS__])
#else
#define DDLog(...)
...
#define kStateBarHeight             (kScreenHeight >= 812.0 ? 44.0 : 0.0)
///TabBar高度
...
#define kMainColor          kHexColor(0x009688)
#define kBgColor            kHexColor(0xF2F2F2)
#define kTitleColor         kHexColor(0x333333)
#define kContentColor       kHexColor(0x666666)
#define kSubTitleColor      kHexColor(0x888888)
#define kTimeColor          kHexColor(0x999999)
#define kPlaceholderColor   kHexColor(0xcccccc)
#define kSeperatorColor     kHexColor(0xd8d8d8)
#define kBlackColor         kHexColor(0x000000)

#define kPlaceHolderImageColor   kHexColor(0xd8d8d8)
#define kTextBlueColor          kHexColor(0x48689e)
...
#define kPlaceholderImage           [UIImage imageNamed:@"pic"]
#define kPlaceholderHeaderImage     [UIImage imageNamed:@"userImage_home"]
